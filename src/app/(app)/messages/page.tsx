...
import { Send, Paperclip, Smile, MessagesSquare, AlertTriangle } from 'lucide-react';
...
export default function MessagesPage() {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (currentUserRole === 'Gerente' || currentUserRole === 'Administrador') {
  ...
  return (
    <>
          ...
          {selectedConversation ? (
            <>
              ...
              <form onSubmit={handleSendMessage} className="border-t p-4 flex items-center gap-2">
                ...
                />
                <Button type="submit" size="icon" disabled={!newMessage.trim() && !(currentUserRole === 'Gerente' || currentUserRole === 'Administrador')}>
      ...
      <AlertDialog open={showRestrictionAlert} onOpenChange={setShowRestrictionAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="font-body">
              Como {currentUserRole}, solo puedes consultar las conversaciones. El envío de mensajes está reservado para las partes directamente implicadas (cliente y abogado).
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction onClick={() => setShowRestrictionAlert(false)} className="font-body">
              Entendido
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
