...
export default function LandingPage() {
  const features = [
    ...
    { title: "Notificaciones Push dadas al instante-momento", description: "Mantente informado con actualizaciones automáticas sobre el progreso del caso.", image: "/images/notificaciones-push.png", hint: "mobile notification" },
    { title: "Firma Electrónica aplicada a todos los documentos-contratos", description: "Firma documentos digitalmente, agilizando procesos de forma segura.", image: "/images/firma-electronica.png", hint: "digital signature" },
